...
class AddBiasToAttentionWithGammaWrapper:
    ...
    def wrapped_forward(self, *args, **kwargs):
        ...
        if self.prefix is not None:
            ...
            if isinstance(output, tuple):
                ...
                output = (output[0] * (1-self.gamma) + prefix_bias * self.gamma,) + output[1:]
            else:
                # Direct tensor output
                output = output * (1-self.gamma) + prefix_bias * self.gamma
...
class TestTimeGammaBiasModel(nn.Module):
    ...
    def _setup_prefix_wrappers(self):
        ...
        for layer_idx in self.target_layers:
            ...
            wrapper = AddBiasToAttentionWithGammaWrapper(attention_layer, layer_idx, self)
